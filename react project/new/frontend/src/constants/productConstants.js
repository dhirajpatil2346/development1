...
export const PRODUCT_CAROUSEL_REQUEST = "PRODUCT_CAROUSEL_REQUEST";
export const PRODUCT_CAROUSEL_SUCCESS = "PRODUCT_CAROUSEL_SUCCESS";
export const PRODUCT_CAROUSEL_FAILURE = "PRODUCT_CAROUSEL_FAILURE";